...
from project_atlas.incremental_connect_read import build_incremental_connect_read
...
def build_tool_dispatch(service: AppService) -> Mapping[str, Callable[[], dict[str, Any]]]:
    ...
    return {
        ...
        "atlas.ops.incremental-connect.read": lambda: build_incremental_connect_read(
            service.vault
        ),
    }
