...
The state lens reads vault review/compile artifacts only. After a disk
...
Independent of #380/#381/#383/#385/#386/#387. Does not rewrite
...
PACKAGE_ID: Final[str] = "AS-CODER-ALPHA-STATE-STALE-001"
GENERATOR_ID: Final[str] = "atlas-coder-alpha-state-stale-001"
...
class StateStaleError(ValueError):
    """Fail-closed state stale-inventory error."""
...
def _safe_project_id(project_id: str) -> str:
    try:
        ...
        raise StateStaleError(str(exc)) from exc
