...
Projects ``atlas next`` for agents and Web. Never writes Layer B.
Never materializes ``generated/answers/``. NEXT != AUTHORITY.
NEXT ACTION != COMMAND. No implicit portfolio-all.
"""
...
def read_project_next(vault: Path, project_id: str) -> dict[str, Any]:
    ...
    honesty["not_as_2_0_next_001"] = True
