...
DEFAULT_TOOLS: tuple[McpTool, ...] = (
    ...
    McpTool(
        ...
        "vault-read",
        True,
        "allow-list candidate; Coder Alpha What Next REPORT READ (vault-scoped, read-only)",
    ),
    McpTool(
        "atlas.changed.read",
        "vault-read",
        True,
        "allow-list candidate; Coder Alpha What Changed REPORT READ (vault-scoped, read-only)",
    ),
    McpTool(
        "atlas.overview.read",
        "vault-read",
        True,
        "allow-list candidate; Coder Alpha Overview REPORT READ (vault-scoped, read-only)",
    ),
    McpTool(
        "atlas.decisions.read",
        "vault-read",
        True,
        "allow-list candidate; Coder Alpha Decisions REPORT READ (vault-scoped, read-only)",
    ),
    McpTool(
        "atlas.unknown.read",
        "vault-read",
        True,
        "allow-list candidate; Coder Alpha Unknown REPORT READ (vault-scoped, read-only)",
    ),
    McpTool(
        "atlas.state.read",
        "vault-read",
        True,
        "allow-list candidate; Coder Alpha State REPORT READ (vault-scoped, read-only)",
    ),
    McpTool(
        "atlas.architecture.read",
        "vault-read",
        True,
        "allow-list candidate; Coder Alpha Architecture REPORT READ (vault-scoped, read-only)",
    ),
    McpTool(
        "atlas.roadmap.read",
        "vault-read",
        True,
        "allow-list candidate; Coder Alpha Roadmap answers REPORT READ (vault-scoped, read-only)",
    ),
    McpTool(
        "atlas.portfolio.read",
        "vault-read",
        True,
        "allow-list candidate; Coder Alpha portfolio REPORT READ (vault-scoped, read-only)",
    ),
    McpTool(
        "atlas.bitemporal.read",
        "vault-read",
        True,
        "allow-list candidate; Coder Alpha bitemporal REPORT READ (vault-scoped, read-only)",
    ),
    McpTool(
        "atlas.indexes.read",
        "vault-read",
        True,
        "allow-list candidate; Coder Alpha index-status REPORT READ (vault-scoped, read-only)",
    ),
    McpTool(
        "atlas.vault.write",
        "vault-write",
