...
DEFAULT_TOOLS: tuple[McpTool, ...] = (
    ...
    McpTool(
        ...
        "vault-read",
        True,
        "allow-list candidate; Coder Alpha overview lens (vault-scoped, read-only)",
    ),
    McpTool(
        "atlas.decisions.read",
        "vault-read",
        True,
        "allow-list candidate; Coder Alpha decisions lens (vault-scoped, read-only)",
    ),
    McpTool(
        "atlas.unknown.read",
        "vault-read",
        True,
        "allow-list candidate; Coder Alpha unknown/conflict lens (vault-scoped, read-only)",
    ),
    McpTool(
        "atlas.changed.read",
        "vault-read",
    ...
    McpTool(
        ...
        "vault-read",
        True,
        "allow-list candidate; Coder Alpha session captures (vault-scoped, read-only, no record)",
    ),
    McpTool(
        "atlas.vault.write",
        "vault-write",
