...
def connect_project(
    ...
    *,
    ...
    if include_portfolio:
        ...
        steps.append("build_bitemporal_catalogs")
    ...
    try:
        ...
        if include_portfolio:
            ...
            # CLI ``atlas build-portfolio`` always derives Time Machine catalogs.
        ...
        from project_atlas.project_next import materialize_next_lenses
        ...
        nxt = materialize_next_lenses(vault_path)
