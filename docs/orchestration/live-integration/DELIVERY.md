...
Recorded: **72 passed** (see runs `component-tests.txt`).
...
| Independent reviewer | Review this candidate; local tests are not IV |
...
See `/home/gebruiker/Projects/project-atlas-runs/live-component-integration-002/`
for `atlas-live-integration-002-*.bundle` and `.sha256`.
