...
|---|---|---|
| AS-2.2-RESEARCH-001 | `research/`, `contracts/research/`, `fixtures/research/` | **PREP** |

Sibling 2.2 prep PRs may add other directories under this tree. Do not treat
presence of this README as charter freeze or implementation unlock.
