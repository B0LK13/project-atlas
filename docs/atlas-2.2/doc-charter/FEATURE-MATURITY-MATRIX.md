...
Tip baseline: `bbbdc12` (post #198). Classes per [`../CHARTER.md`](../CHARTER.md).
...
5. Machine-readable rehearsal: [`fixtures/maturity-matrix.fixture.json`](fixtures/maturity-matrix.fixture.json).
