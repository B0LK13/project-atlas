...
```
D080_MERGE_CANDIDATE = SUPERSEDED_BY_D084
...
D-081 authentic Run A on this freeze was FAIL (3/5). Do not re-target Local
at `99aa937`. Local D-085 validates the D-084 freeze.
