...
This-branch replay (2026-08-24):

- `POST_FIX_OWNER_GATE=MERGE`
- `POST_FIX_STATUS=BLOCKED_OWNER`
- `POST_FIX_OWNER_CAPABILITY_GRANTED=False`
- `POST_FIX_BYPASS=False`
- `MAIN_VULN_REPLAY_EXPECTED_BYPASS=True`
