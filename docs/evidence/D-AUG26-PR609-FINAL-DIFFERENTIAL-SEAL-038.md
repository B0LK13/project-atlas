> **INVALIDATED by D-042** — `METHODOLOGY_VALID = NO`. See `D-AUG26-COMPETING-D038-METHODOLOGY-RECONCILIATION-042.json`.
...
| NEW_CARRIER_WORKLOG_ENCODING_CORRUPTION | NO |
| PR609_NEW_MOJIBAKE_OCCURRENCE_COUNT | 0 |
