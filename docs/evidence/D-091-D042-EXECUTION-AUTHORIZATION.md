...
See `docs/evidence/D-092-LOCAL-REVALIDATION-RUNBOOK.md` and
...
LOCAL_D092_GOVERNED_PROJECT_PRECONDITION = SATISFIED_BY_D092A
LOCAL_D092_READY = YES
D092A_RESULT = PASS
D092_RECONCILED_RESULT = PASS
D091_LOCAL_ACCEPTANCE = PASS
```

See `docs/evidence/D-094-FINAL-RECONCILIATION.md`. Cloud still cannot
observe the owner Windows estate; Local PASS is owner-supplied.
