...
| AS-2.1-MCP-ADV-001 | ADV | OPEN | READ ONLY probes; unknown/escalation/write-via-read/path/malformed/replay |
...
Parent W01–W06 (#155 duplicates) **SUPERSEDED**. Active capacity on 2.2 prep workers W07–W16.

**Separate north-star backlog:** `docs/strategy/` — unlock runtime after v2.1.0.

Release gated on authentic PILOT PASS. `ATLAS_2_1_RELEASE_CERTIFIED=NO`.
