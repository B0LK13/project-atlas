...
Tip: `4f3ade9` / TREE `80a4ba55`. `ATLAS_2_1_RELEASE_CERTIFIED = NO`.
...
| AS-2.1-WEB-LIVE-001 | 1–5 | MERGED #153/#155 | Mission/Workspace/Ops LIVE |
...
| AS-2.1-AUTONOMY-L3-001 | 2/5 | MERGED #153/#155 | loop + job-matrix ADV |
...
| AS-2.1-ASK / OBS / OPS-RECEIPTS | 2–5 | MERGED #155 | `/v1/ops/receipts` honest |
| AS-2.1-OAI-RESPONSES-POC-001 | 3 | MERGED #146 | NON_RELEASE_BLOCKING |
| AS-2.1-ADV-LIVE-001 | 3–5 | MERGED #147–#155 | Host/CORS + L3 matrix |
...
**BOARD_EMPTY_EXCEPT_AUTHENTIC_PILOT** for release-hardening.

H01–H05 Track B harden drained (#153–#155). Remaining P0 is authentic PILOT (+ post-PILOT SYNC/TWIN/E2E/ADV-RC/REL).

Optional non-P0 polish only (not scope widen): further Mission/Workspace visuals.
