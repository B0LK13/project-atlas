...
Tip: `5fcaba3` (+ Track B deepen-002). `ATLAS_2_1_RELEASE_CERTIFIED = NO`.
...
| AS-2.1-WEB-LIVE-001 | 1/4 | MERGED #149 | LIVE-first + demo isolation |
...
| AS-2.1-COLLAB-001 | 2/4 | DEEPENING | close-session receipt |
| AS-2.1-WEB-ACTIONS-001 | 2 | MERGED #145 | Action ledger |
| AS-2.1-PROV-LIVE-001 | 2/4 | DEEPENING | ADV provider bounds |
| AS-2.1-ASK-ATLAS-LIVE / OBS-LIVE | 2/4 | MERGED #149 | health keywords + OBS perf |
| AS-2.1-OAI-RESPONSES-POC-001 | 3 | MERGED #146 | EXPERIMENTAL non-blocking |
| AS-2.1-ADV-LIVE-001 | 3/4 | DEEPENING | provider/collab ADV |
| AS-2.1-PERF-BASELINE-001 | 4 | MERGED #149 | Local read baselines |
