...
- [x] AS-2.1-OBS-READ-001 read-only observability compute (`GET /v1/obs` + `atlas.obs.read` do not write; persist remains explicit `build_live_observability_receipt`; OBS!=authority)
