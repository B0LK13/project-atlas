...
- [x] AS-CODER-ALPHA-OPS-REPORT-READ-001 vault-scoped ops-report REPORT READ (`atlas ops-report-status`; `atlas.ops.report.read`; never emits; OPS REPORT != AUTHORITY)
