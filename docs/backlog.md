...
- [x] AS-CODER-ALPHA-OVERVIEW-READ-001 vault-scoped Overview REPORT READ (`atlas overview-status`; `atlas.overview.read`; never materializes; OVERVIEW != AUTHORITY; UI != CANONICAL)
