...
- [x] AS-CODER-ALPHA-INVENTORY-DRIFT-READ-001 vault-scoped inventory-drift lens (`atlas inventory-drift`, `/v1/inventory-drift`, `#/inventory-drift`, `atlas.inventory.drift.read`; STALE!=CURRENT; UNKNOWN!=FRESH; LENS!=AUTHORITY; draft; MERGE_AUTHORIZATION NOT_GRANTED)
