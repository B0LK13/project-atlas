...
- [x] AS-D149R3-DEPENDENCY-AND-EVIDENCE-001 SUPERSEDED MERGE dependencies preserved; D-148 evidence fail-closed on missing fingerprint/root (implemented; MERGE_AUTHORIZATION NOT_GRANTED; independent IV of #446 residuals)
...
- [x] AS-D148-O2-OBJECTIVE-HONESTY-001 acceptance-workflow pilot no longer lists AUTHENTIC_QUERY as unfinished when query already passed (implemented; MERGE_AUTHORIZATION NOT_GRANTED)
...
- [x] ORCH001C-009 Independent integration verification (re-certification required after R1 HEAD/TREE move)
