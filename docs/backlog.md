...
- [x] AS-CODER-ALPHA-RUNTIME-READ-001 vault-scoped runtime REPORT READ (`atlas runtime report` / `GET /v1/runtime/report` / `atlas.runtime.read`; RUNTIME!=AUTHORITY; INDEXES!=TRUTH CORE; WRITE_APPLIED=false)
