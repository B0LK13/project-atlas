...
- [x] AS-CODER-ALPHA-AUTHZ-READ-001 vault-scoped GET /v1/authz REPORT READ (`atlas authz report` / `GET /v1/authz/report` / `atlas.authz.read`; AUTHZ!=AUTHORITY; PROFILE!=GRANT; CAPABILITY_LIST!=OWNER_GATE; WRITE_ENABLED=false)
