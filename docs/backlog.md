...
- [ ] VALIDATE-OKF-YAML-CONSTRUCTOR-KEYERROR Map PyYAML ``!!bool`` constructor ``KeyError`` onto the structured invalid-OKF-concept-note finding (IMPLEMENTED; AWAITING IV -- merge NOT pre-authorized). Sibling of #819 / #820 / #822 / #823. Does not touch ``ingestion.py``. Evidence: ``docs/evidence/VALIDATE-OKF-YAML-CONSTRUCTOR-KEYERROR.md``.
