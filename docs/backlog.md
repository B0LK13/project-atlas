...
- [x] AS-CODER-ALPHA-OBS-READ-001 vault-scoped live observability REPORT READ (`atlas ops obs` / `atlas.obs.read`; OBS!=AUTHORITY; LIVE_RECEIPT!=CERTIFICATION; EMPTY!=HEALTHY; UNKNOWN!=HEALTHY; MCP!=AUTHORITY; WRITE_APPLIED=false)
