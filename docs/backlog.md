...
- [x] AS-CODER-ALPHA-EVENT-RETENTION-READ-001 vault-scoped event-retention REPORT READ (`atlas retention report` / `GET /v1/event-retention` / `atlas.event.retention.read`; REPORT!=AUTHORITY; RETENTION REPORT!=APPLY; LENS!=TRUTH CORE)
