...
- [x] AS-CODER-ALPHA-OPT-GATE-READ-001 vault-scoped opt-gate REPORT READ (`atlas opt-gate report` / `GET /v1/opt-gate/report` / `atlas.opt-gate.read`; OPT-GATE!=OPT; PROMOTE_ELIGIBLE!=MERGED; WAKE_GATE=CLOSED; WRITE_APPLIED=false)
