...
- [x] AS-CODER-ALPHA-BITEMPORAL-READ-001 vault-scoped validity-catalog REPORT READ (`atlas bitemporal-status`; `atlas.bitemporal.read`; never materializes; CATALOG != AUTHORITY; GRAPH != AUTHORITY)
