...
- [x] AS-CODER-ALPHA-ASK2-READ-001 vault-scoped Ask Atlas 2 REPORT READ (`atlas ask2-status report` / `GET /v1/ask2/report` / `atlas.ask2.read`; ASK2 REPORT!=ANSWER; WRITE_APPLIED=false)
