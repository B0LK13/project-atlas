...
- [ ] AS-CODER-ALPHA-CONTEXT-STALE-GUARD-001 STALE/UNKNOWN context and handoff packs must not look current (current-main; reuses inventory_drift; do not retarget #380; MERGE_AUTHORIZATION NOT_GRANTED)
