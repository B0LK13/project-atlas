...
- [x] AS-CODER-ALPHA-INDEX-STATUS-001 vault-scoped lexical index readiness (`atlas index-status`, `/v1/index-status`, `#/indexes`, `atlas.indexes.status.read`; INDEX_STATUS≠authority; UNKNOWN≠HEALTHY; not merge-eligible)
