...
- [x] AS-CODER-ALPHA-INTELLIGENCE-READ-001 vault-scoped intelligence REPORT READ (`atlas intelligence report` / `GET /v1/intelligence` / `atlas.intelligence.read`; INTELLIGENCE!=AUTHORITY; GRAPH!=AUTHORITY; DERIVED!=TRUTH CORE; EMPTY!=HEALTHY; UNKNOWN!=HEALTHY; WRITE_APPLIED=false)
