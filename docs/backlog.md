...
- [ ] AS-CODER-ALPHA-CAPTURE-002 Conversational capture (D-042; GATE OPEN after D-049 CLOSED; not implemented; requires fresh owner-authorized execution on accepted main)
