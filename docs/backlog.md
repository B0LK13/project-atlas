...
- [x] AS-CODER-ALPHA-KF2-READ-001 vault-scoped Knowledge Fabric REPORT READ (`atlas kf2 report` / `GET /v1/kf2` / `atlas.kf2.read`; KF2!=AUTHORITY; NAME!=IDENTITY; MISSING!=REGISTERED; EMPTY!=HEALTHY; WRITE_APPLIED=false)
