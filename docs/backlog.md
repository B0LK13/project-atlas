...
- [x] AS-CODER-ALPHA-PROVIDER-READ-001 vault-scoped provider registry/quarantine REPORT READ (`atlas provider report` / `GET /v1/provider` / `atlas.provider.read`; PROVIDER!=AUTHORITY; REGISTRY!=LIVE SDK; QUARANTINE!=APPROVED; MISSING!=ENABLED; EMPTY!=HEALTHY; WRITE_APPLIED=false)
