...
- [x] AS-CODER-ALPHA-TWIN-READ-001 vault-scoped twin-fixture REPORT READ (`atlas twin-fixture report` / `GET /v1/twin-fixture/report` / `atlas.twin.read`; TWIN FIXTURE!=PILOT; WRITE_APPLIED=false)
