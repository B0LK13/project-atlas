...
- [x] AS-CODER-ALPHA-CAPTURE-READ-001 vault-scoped session-capture REPORT READ (`atlas capture report` / `GET /v1/capture/report` / `atlas.capture.read`; CAPTURE!=AUTHORITY; WRITE_APPLIED=false)
