...
- [x] AS-CODER-ALPHA-CONNECT-STATUS-001 vault-scoped last-connect read (`atlas connect-status`, `/v1/connect-status`, `#/connect`, `atlas.connect.status.read`; CONNECT_STATUS≠authority; UNKNOWN≠FRESH; not merge-eligible)
