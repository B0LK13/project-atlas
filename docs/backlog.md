...
- [x] AS-CODER-ALPHA-INCREMENTAL-CONNECT-001 no-change reconnect must not double discover+ingest (implementation on live main; unit 13 passed 2026-08-24T22:15Z; skip is operational only, not Truth Core authority)
