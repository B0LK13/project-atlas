...
- [x] AS-CODER-ALPHA-PORTFOLIO-READ-001 vault-scoped Layer C portfolio REPORT READ (`atlas portfolio-status`; `atlas.portfolio.read`; never materializes; PORTFOLIO != AUTHORITY; LAYER C != TRUTH CORE)
