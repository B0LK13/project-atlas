...
- [x] AS-CODER-ALPHA-DECISIONS-READ-001 vault-scoped Decisions REPORT READ (`atlas decisions-status`; `atlas.decisions.read`; never materializes; DECISIONS != AUTHORITY)
