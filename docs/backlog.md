...
- [x] AS-CODER-ALPHA-DISCOVERY-MCP-001 vault-scoped estate discovery MCP (`atlas.discovery.read`; absent report invents no PILOT roots)
- [x] AS-CODER-ALPHA-OPS-RECEIPTS-MCP-001 vault-scoped ops receipt inventory MCP (`atlas.ops.receipts.read`; presence≠healthy ≠PILOT)
