...
- [x] AS-CODER-ALPHA-COMPAT-READ-001 vault-scoped compatibility-anchor REPORT READ (`atlas compat report` / `GET /v1/compat/report` / `atlas.compat.read`; COMPAT!=AUTHORITY; CERTIFIED!=GA; WRITE_APPLIED=false)
