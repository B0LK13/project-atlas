...
- [x] AS-CODER-ALPHA-XPROJ-READ-001 vault-scoped xproj REPORT READ (`atlas xproj report` / `GET /v1/xproj` / `atlas.xproj.read`; XPROJ!=AUTHORITY; GRAPH!=AUTHORITY; LENS!=TRUTH CORE; WRITE_APPLIED=false)
