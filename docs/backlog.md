...
- [x] AS-CODER-ALPHA-CONTEXT-PACK-READ-001 vault-scoped context-pack REPORT READ (`atlas context-pack report` / `GET /v1/context-pack/report` / `atlas.context-pack.read`; CONTEXT PACK!=ESTATE FACTS; WRITE_APPLIED=false)
