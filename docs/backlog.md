...
- [x] AS-CODER-ALPHA-MISSION-READ-001 vault-scoped GET /v1/mission REPORT READ (`atlas mission report` / `GET /v1/mission/report` / `atlas.mission.read`; MISSION!=AUTHORITY; VIEW!=TRUTH CORE; EMPTY!=HEALTHY; UNKNOWN!=HEALTHY; WRITE_APPLIED=false)
