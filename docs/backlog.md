...
- [ ] CORE2-007 Complete ConceptRecord/Claim projection composition and migrations
  ...
  via Rules A–D; AS-CORE-MODEL-001B Capability emission in progress on feat/as-core-model-001b-capability; multi-type composition remains AS-CORE-MODEL-001C.)
