...
- [x] AS-CODER-ALPHA-REVOCATIONS-READ-001 vault-scoped receipt-revocation list (`atlas revocations`, `/v1/ops/revocations`, `#/revocations`, `atlas.ops.revocations.read`; EMPTY≠HEALTHY; ABSENT≠FABRICATED; REVOCATION≠AUTHORITY; draft; MERGE_AUTHORIZATION NOT_GRANTED)
