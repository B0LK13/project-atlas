...
- [x] AS-CODER-ALPHA-KCI-READ-001 vault-scoped Knowledge CI REPORT READ (`atlas kci report` / `GET /v1/kci` / `atlas.kci.read`; KCI!=AUTHORITY; RECEIPT!=CERTIFICATION; EMPTY!=HEALTHY; MISSING!=PASS; WRITE_APPLIED=false)
