...
- [x] AS-CODER-ALPHA-INDEX-STATUS-001 vault-scoped lexical index REPORT READ (`atlas index-status`; `atlas.indexes.read`; never materializes; INDEX_STATUS != AUTHORITY; PRESENCE != VALIDATE; stale #497 superseded, not merged)
