...
- [x] AS-CODER-ALPHA-SCHEMA-COMPAT-READ-001 vault-scoped schema-compat REPORT READ (`atlas schema report` / `GET /v1/schema-compat` / `atlas.schema.compat.read`; REPORT!=AUTHORITY; SCHEMA-COMPAT!=MIGRATION APPLY; LENS!=TRUTH CORE)
