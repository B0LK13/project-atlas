...
- [x] AS-CODER-ALPHA-FED-READ-001 vault-scoped federation REPORT READ (`atlas federation report` / `GET /v1/fed/report` / `atlas.fed.read`; FED!=AUTHORITY; FED!=CROSS-VAULT PROMOTE; WRITE_APPLIED=false)
