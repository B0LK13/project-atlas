...
```
$ gh api repos/bolkdev/project-atlas/rulesets
[]
```
...
```
$ gh api repos/bolkdev/project-atlas/branches/main/protection
```
...
```
$ gh api repos/bolkdev/project-atlas/branches/main/protection/required_status_checks
