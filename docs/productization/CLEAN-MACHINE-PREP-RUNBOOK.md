...
| Requirement | Notes |
|---|---|
| Git | clone `https://github.com/bolkdev/project-atlas` |
...
git clone --depth 1 https://github.com/bolkdev/project-atlas.git $WORK
cd $WORK
...
- `HEAD` = `2b8ebab468d4b9e9ce119a86b5a5350de3df96b3`
- `TREE` = `817df2a42ae6f47d08510147daab5ba565471517`
