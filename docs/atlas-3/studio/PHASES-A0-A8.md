...
| A2 | Governed claim/dispatch/handoff/open-worktree/terminal | **A2-001 OWNERSHIP_CLAIM IMPLEMENTED_IN_LANE** — see `a2/A2-EVIDENCE.md` + ADR-035 + `a2/A2-001-STATUS-CURRENT.md`. Formal IV PASS on tip `2debb778` (separate verifier); merge/review gates external. Dispatch/steal-auto/handoff-delivery/worktree/PTY = NOT_STARTED. **A2-002 Mission Journey RO slice** — see `a2-002/` (MC+knowledge+dev+claim next-steps; no mutation). |
