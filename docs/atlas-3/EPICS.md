...
| AT3-021 | Derived relationship expansion | PREP | AS-GRAPH-003 + twin aliases |
...
| AT3-061 | Intent vs current-state separation | PREP (enforced in memory reconcile) |
...
| AT3-051 | Independent verification binding | NOT_STARTED | AS-ORCH result envelope |
| AT3-052 | ADV binding | NOT_STARTED | adv_release_cert |
...
| ID | Title | Status |
|---|---|---|
| AT3-100 | Twin health | NOT_STARTED |
