...
| AT3-023 | Graph ≠ authority enforcement | ISOLATED_RUNTIME | prove_graph_is_not_authority; winners/trust fail closed |
...
| AT3-046 | Incremental conversation sync | ISOLATED_RUNTIME | local export-cursor; live provider incremental EXTERNAL_BLOCKED |
...
| AT3-092 | Truth Graph UX | ISOLATED_RUNTIME |
| AT3-093 | Time Machine UX reuse | ISOLATED_RUNTIME |
| AT3-094 | Decision Explorer | ISOLATED_RUNTIME |
| AT3-095 | Impact Explorer | ISOLATED_RUNTIME |
| AT3-096 | Mission Command Center | ISOLATED_RUNTIME |
...
| AT3-102 | Provider sync status | ISOLATED_RUNTIME |
