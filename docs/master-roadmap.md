...
| AS-GH-001 | GitHub repository governance baseline | **Architecture certified and integrated into `main`; bounded repository-implementation slice complete — independent verification, remaining artifacts, and settings activation pending** (see `docs/adr/ADR-006-github-repository-governance-baseline.md`, `docs/work-packages/AS-GH-001.md`, `docs/evidence/AS-GH-001-receipt.yaml`) |
