...
def test_no_production_mutation_paths_in_prep_tree() -> None:
    ...
    for name in changed:
        ...
        assert (
            name.startswith("docs/atlas-2.2/dod-compiler/")
            or name.startswith("docs/atlas-2.2/fixtures/dod-compiler/")
            or name == "tests/unit/test_as_2_2_dod_deepen_prep_001.py"
        ), name
