...
## AS-ASK2-F1 — Secret-shaped provenance must not be echoed

**Date:** 2026-09-13
**Branch:** `fix/as-ask2-secret-provenance`
**Base:** `b87b4a226f4aa8b2f669edf112aa3476454f754f`
**MERGE_AUTHORIZATION:** NOT_GRANTED

Independently reproduced on live main: Ask Atlas 2 / p2 compiler kept
`AKIA...` provenance refs in EVIDENCE. D-178/D-181 only covered claim
values.

Fix: drop secret-shaped refs in `_record_provenance` and
`_sanitize_provenance`. NFR-004 / AT-014.
