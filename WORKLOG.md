...
## OPS-HEALTH-YAML-CONSTRUCTOR-KEYERROR

**Date:** 2026-09-13
**Branch:** `fix/ops-health-yaml-constructor-keyerror`
**Base:** `b87b4a226f4aa8b2f669edf112aa3476454f754f`
**Mode:** Night-cycle autonomous remediation. `MERGE_AUTHORIZATION = NOT_GRANTED`.

Same constructor leak as F7-R1 / #819–#825, at the ops-health YAML
mapping helper used for agent-readiness. Constructor ``KeyError`` now
returns ``None`` (unreadable). Does not touch `ingestion.py`.
