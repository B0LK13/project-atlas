...
**Date:** 2026-09-13
**Branch:** `fix/at3048-persist-result-project-scope`
**Base:** `b87b4a226f4aa8b2f669edf112aa3476454f754f`
**MERGE_AUTHORIZATION:** NOT_GRANTED

IV residual of #836: a no-hits envelope with `project_id: other-api` persisted under `harbor-api`. Persist now binds `result.project_id` when present. Does not widen #836. `ingestion.py` untouched.

Evidence: `docs/evidence/AT3-048-F3-PERSIST-RESULT-PROJECT-SCOPE.md`
