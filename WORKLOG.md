...
## VALIDATE-OKF-YAML-CONSTRUCTOR-KEYERROR

**Date:** 2026-09-13
**Branch:** `fix/validate-okf-yaml-constructor-keyerror`
**Base:** `b87b4a226f4aa8b2f669edf112aa3476454f754f`
**Mode:** Night-cycle autonomous remediation. `MERGE_AUTHORIZATION = NOT_GRANTED`.

Same constructor leak as F7-R1 / #819 / #820 / #822 / #823, at the
OKF concept-note frontmatter loader used by ``atlas validate``.
Constructor ``KeyError`` now records the existing structured finding.
